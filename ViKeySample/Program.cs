...
//                 }
                ...
                buffer = System.Text.Encoding.Default.GetBytes(Computer.GetCpuID() + Computer.GetHardDiskID());
                
                //buffer = System.Text.Encoding.Default.GetBytes(str1); // convert unicode to asccii
                // write data to Vikey
                Addr = 0;
                Length = (ushort)(Computer.GetCpuID().Length + Computer.GetHardDiskID().Length);
                ...
                //System.Console.WriteLine("Write:" + Computer.GetCpuID() + Computer.GetHardDiskID());

                //		p1 = 4;
                //		p2 = 26;
                buffer = new Byte[Computer.GetCpuID().Length + Computer.GetHardDiskID().Length];
